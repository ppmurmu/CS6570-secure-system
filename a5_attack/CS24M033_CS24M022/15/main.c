...
uint8_t egg_params[5][6] = {{}, {}}; // NOT DONE

uint8_t compute_gf(uint8_t *eggs)
{
    return 0 * eggs[1] + 0 * eggs[1] - eggs[2]; // NOT DONE
}
...
int main(int argc, char *argv[])
{
    ...
    // table used
    uint8_t key[AES_BLOCKLEN] = {0xc6, 0x89, 0x6e, 0x35, 0x54, 0xee, 0x81, 0x0d, 0xe4, 0x7b, 0xd1, 0x16, 0x00, 0x0e, 0xe0, 0xc5};
